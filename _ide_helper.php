...
namespace {
    ...
    class Constants extends \App\Http\Constants{
        
    }


    class Logger extends \Powerlaw\Livius\Facades\Livius{
        ...
        public static function error(){
            return \Powerlaw\Livius\Livius::error();
        }
        
    }


    class Helper extends \Powerlaw\Soraka\Facades\Soraka{
         ...
         * @static 
         */
        public static function instance($name, $parameters = array()){
            return \Powerlaw\Soraka\Soraka::instance($name, $parameters);
        }
        ...
        public static function _(){
            return \Powerlaw\Soraka\Soraka::_();
        }
        
    }


    class ERR extends \Powerlaw\Maiev\Facades\Maiev{
        ...
        public static function getMessages(){
            return \Powerlaw\Maiev\Maiev::getMessages();
        }
        ...
        public static function getMessage($code){
            return \Powerlaw\Maiev\Maiev::getMessage($code);
        }
         ...
         * @static 
         */
        public static function E($code = 10000, $message = '', $errors = null){
            return \Powerlaw\Maiev\Maiev::E($code, $message, $errors);
        }
         ...
         * @static 
         */
        public static function R($data = null, $header = null){
            return \Powerlaw\Maiev\Maiev::R($data, $header);
        }
        ...
        public static function D($data){
            return \Powerlaw\Maiev\Maiev::D($data);
        }
        
    }


    class ID extends \Powerlaw\Eunomia\Facades\Eunomia{
        ...
        public static function getClasses(){
            return \Powerlaw\Eunomia\Eunomia::getClasses();
        }
        ...
        public static function getClassName($key){
            return \Powerlaw\Eunomia\Eunomia::getClassName($key);
        }
         ...
         * @static 
         */
        public static function getTimestamp($micro = true){
            return \Powerlaw\Eunomia\Eunomia::getTimestamp($micro);
        }
        ...
        public static function gen(){
            return \Powerlaw\Eunomia\Eunomia::gen();
        }
        
    }


    class Header extends \Powerlaw\Dullahan\Facades\Dullahan{
        ...
        public static function getHeaders(){
            return \Powerlaw\Dullahan\Dullahan::getHeaders();
        }
        ...
        public static function getHeader($key){
            return \Powerlaw\Dullahan\Dullahan::getHeader($key);
        }
         ...
         * @static 
         */
        public static function page($pager){
            return \Powerlaw\Dullahan\Dullahan::page($pager);
        }
